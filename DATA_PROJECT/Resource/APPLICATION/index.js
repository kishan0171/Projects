...
var mainApp = angular.module('mainApp', ['ngTouch', 'ngAnimate', 'ui.grid', 'ui.grid.pagination', 'ui.grid.exporter']);
...
mainApp.controller("mainController", ['$scope', '$http', function ($scope, $http) {
    ...
    $http({
        url: "../_WebService/WebService1.asmx/GetData",
        dataType: 'json',
        method: 'POST',
        data: "{}",
        headers: {
   ...
   "</div>";
    ...
    {
        $http({
            url: "../_WebService/WebService1.asmx/Update",
            dataType: 'json',
            method: 'POST',
            data: "{}",
            headers: {
